    ...
    return(
        <div className="aboutus">
            ...
            <div className="bubbles">
                ...
                <img src={Greg} alt="Grégoire Richard" className="greg"/>
                <img src={Lancelot} alt="Lancelot Perinet-Marquet" className="lancelot"/>
                <img src={Lenaze} alt="Léna Vulliez" className="lenaze"/>
                <img src={Flow} alt="Floriane Ryan" className="flow"/>
